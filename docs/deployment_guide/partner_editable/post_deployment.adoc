...
== Operational
For help with operational tasks such as creating a QuickSight dashboard, see the https://aws-quickstart.github.io/quickstart-grid-connect-connectsense/operational/index.html[Operational guide].
